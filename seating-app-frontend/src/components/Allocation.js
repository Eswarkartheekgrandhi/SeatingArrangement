...
import BackendResponseTable from "./Backenddata";
...
const Allocation = () => {
  ...
  const [taleview, settableview] = useState(false);
  ...
  const handleArrangeSeats = () => {
    ...
    fetch("http://localhost:3001/admin/allocate-rooms", {
      ...
      .then((newData) => {
        console.log("Rooms allocated successfully:", newData);
        // Update allocateddata state by appending the new data to the previous data
  ...
  return (
    <div className="classrooms">
      <div className="container">
        ...
        {taleview && (
          <div className="allocation-response">
            <BackendResponseTable data={allocateddata} />
          </div>
        )}
      </div>
      <div className="below">
